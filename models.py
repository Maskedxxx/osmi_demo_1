...
class DefectAnalysisResult(BaseModel):
    ...
    room: Literal[
        "Гостиная", "Спальня", "Детская", "Кабинет",
        "Кухня", "Ванная", "Туалет", "Коридор", "Прихожая", "Балкон", "Лоджия",
        "Кладовая", "Гардеробная", "Жилое помещение"
    ] = Field(..., description="Верхнеуровневый тип помещения в котором обнаружен дефект")
    location: Literal[
        "Пол", "Потолок", "Стена", "Межкомнатная дверь", "Входная дверь", "Окно", "Оконный блок",
        "Сантехника", "Электрика", "Отопление", "Плитка", "Покрытие", "Штукатурка", "Краска"
