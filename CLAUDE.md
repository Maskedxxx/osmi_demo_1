...
# Имеется доступное виртуальное окружение которое вы можете использовать, в нем установлены очень много самых популярных библиотек (/Users/mask/Documents/ПРОЕКТЫ_2024/СОЮЗ_СНАБ_workRepo/knowledge_map_release_v2/ai-neuro/semantic_venv/bin/activate)